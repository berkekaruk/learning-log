...
- _Note:_ A lowercase letter is the number of its uppercase counterpart **+32**. This allows the system to lowercase a letter by changing only one single bit (since 32 is a power of 2).
